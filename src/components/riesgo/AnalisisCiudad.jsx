                ...
                {(() => {
                  ...
                  return (
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                      ...
                      <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-5">
                        <h3 className="font-bold text-gray-700 text-sm mb-3">📊 Participación sobre servicios</h3>
                        <ResponsiveContainer width="100%" height={200}>
                          <PieChart>
                            <Pie data={[
                        ...
                        <div className="flex justify-center gap-3 mt-1 text-[10px] text-gray-500">
                          <span><span className="inline-block w-2.5 h-2.5 rounded-full mr-1" style={{background:SEM_VERDE}}/>Servicios</span>
                          <span><span className="inline-block w-2.5 h-2.5 rounded-full mr-1" style={{background:SEM_ROJO}}/>Dev {totalServAct>0?((totalDevAct/totalServAct)*100).toFixed(1):"0"}%</span>
                          <span><span className="inline-block w-2.5 h-2.5 rounded-full mr-1" style={{background:SEM_AMARILLO}}/>Rel {totalServAct>0?((totalRelAct/totalServAct)*100).toFixed(1):"0"}%</span>
                        </div>
                      </div>
                    </div>
                  );
